...
//-----------------------------------------------------------------------------
class AnimateWindowCC : public MemoryPoolObject
{
	MEMORY_POOL_GLUE_WITH_USERLOOKUP_CREATE(AnimateWindowCC, "AnimateWindowCC")		
public:
	AnimateWindowCC( void );
	//~AnimateWindowCC( void );
...
//-----------------------------------------------------------------------------
typedef	std::list<AnimateWindowCC *>	AnimateWindowList;
...
// INLINING ///////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
	inline ICoord2D			AnimateWindowCC::getStartPos( void )	{ return m_startPos; };
	inline ICoord2D			AnimateWindowCC::getCurPos( void )		{ return m_curPos; };
	inline ICoord2D			AnimateWindowCC::getEndPos( void )		{ return m_endPos; };
	inline ICoord2D			AnimateWindowCC::getRestPos( void )		{ return m_restPos; };
	inline GameWindow  *AnimateWindowCC::getGameWindow( void ){ return m_win; };
	inline AnimTypes		AnimateWindowCC::getAnimType( void )	{ return m_animType; };
	inline UnsignedInt	AnimateWindowCC::getDelay( void )			{ return m_delay; };
	inline Coord2D			AnimateWindowCC::getVel( void )				{ return m_vel; };
	inline UnsignedInt	AnimateWindowCC::getStartTime( void )	{ return m_startTime; };
	inline UnsignedInt	AnimateWindowCC::getEndTime( void )		{ return m_endTime; };

	inline void	AnimateWindowCC::setStartPos( ICoord2D startPos)		{ m_startPos = startPos; };
	inline void	AnimateWindowCC::setCurPos( ICoord2D curPos)				{ m_curPos = curPos; };
	inline void	AnimateWindowCC::setEndPos( ICoord2D endPos)				{ m_endPos = endPos; };
	inline void	AnimateWindowCC::setRestPos( ICoord2D restPos)			{ m_restPos = restPos; };
	inline void	AnimateWindowCC::setGameWindow( GameWindow *win)		{ m_win = win; };
	inline void	AnimateWindowCC::setAnimType( AnimTypes animType)		{ m_animType = animType; };
	inline void	AnimateWindowCC::setDelay( UnsignedInt delay)				{ m_delay = delay; };
	inline void	AnimateWindowCC::setVel( Coord2D vel)								{ m_vel = vel; };
	inline void	AnimateWindowCC::setStartTime( UnsignedInt t )			{ m_startTime = t; }
	inline void	AnimateWindowCC::setEndTime( UnsignedInt t )				{ m_endTime = t; }

	inline void	AnimateWindowCC::setFinished( Bool finished)				{ m_isFinished = finished; };
	inline Bool	AnimateWindowCC::isFinished( void )									{ return m_isFinished; };
	inline void	AnimateWindowCC::setNeedsToFinish( Bool needsToFinish)		{ m_needsToFinish = needsToFinish; };
	inline Bool	AnimateWindowCC::needsToFinish( void )							{ return m_needsToFinish; };
