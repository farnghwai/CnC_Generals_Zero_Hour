...
//						Then setup each of the virtual classes to process an AnimateWindowCC
...
public:
	...
	virtual void initAnimateWindow( AnimateWindowCC *animWin ) = 0;
	virtual void initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay = 0 ) = 0;
	virtual Bool updateAnimateWindow( AnimateWindowCC *animWin ) = 0;
	virtual Bool reverseAnimateWindow( AnimateWindowCC *animWin ) = 0;
...
public:
	...
	virtual void initAnimateWindow( AnimateWindowCC *animWin );
	virtual void initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay = 0 );
	virtual Bool updateAnimateWindow( AnimateWindowCC *animWin );
	virtual Bool reverseAnimateWindow( AnimateWindowCC *animWin );
private:
