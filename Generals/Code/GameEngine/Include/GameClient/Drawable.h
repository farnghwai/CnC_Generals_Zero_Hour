...
public:
	...
	Bool testTintStatus( TintStatus statusBits ) const { return BitTestTwid( m_tintStatus, statusBits ); };
	...
	Bool getShadowsEnabled() const { return BitTestTwid(m_status, DRAWABLE_STATUS_SHADOWS); }
	...
	Bool getDrawsInMirror() const { return BitTestTwid(m_status, DRAWABLE_STATUS_DRAWS_IN_MIRROR) || isKindOf(KINDOF_CAN_CAST_REFLECTIONS); }
