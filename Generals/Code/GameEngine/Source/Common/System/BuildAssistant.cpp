																											 ...
																											 Player *player)
{
	...
	if( BitTestTwid( options, SHROUD_REVEALED ) )
	{
		{
			Int x, y;
	...
	//
	if( BitTestTwid( options, NO_OBJECT_OVERLAP ) )
	{
	...
	//
	if( BitTestTwid( options, NO_ENEMY_OBJECT_OVERLAP ) )
	{
	...
	if( BitTestTwid( options, CLEAR_PATH ) && builderObject )
	{
		...
		//
		if( BitTestTwid( options, USE_QUICK_PATHFIND ) )
		{
	...
	if( BitTestTwid( options, TERRAIN_RESTRICTIONS ) )
	{
