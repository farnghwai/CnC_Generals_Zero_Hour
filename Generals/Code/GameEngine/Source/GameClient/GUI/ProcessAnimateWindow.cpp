...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initAnimateWindow( AnimateWindowCC *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRight::updateAnimateWindow( AnimateWindowCC *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRight::reverseAnimateWindow( AnimateWindowCC *animWin )
{
...
void ProcessAnimateWindowSlideFromLeft::initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromLeft::initAnimateWindow( AnimateWindowCC *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromLeft::updateAnimateWindow( AnimateWindowCC *animWin )
{
...
Bool ProcessAnimateWindowSlideFromLeft::reverseAnimateWindow( AnimateWindowCC *animWin )
{
...
void ProcessAnimateWindowSlideFromTop::initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTop::initAnimateWindow( AnimateWindowCC *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTop::updateAnimateWindow( AnimateWindowCC *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTop::reverseAnimateWindow( AnimateWindowCC *animWin )
{
...
void ProcessAnimateWindowSlideFromBottom::initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromBottom::initAnimateWindow( AnimateWindowCC *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottom::updateAnimateWindow( AnimateWindowCC *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottom::reverseAnimateWindow( AnimateWindowCC *animWin )
{
...
void ProcessAnimateWindowSlideFromBottomTimed::initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
void ProcessAnimateWindowSlideFromBottomTimed::initAnimateWindow( AnimateWindowCC *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottomTimed::updateAnimateWindow( AnimateWindowCC *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottomTimed::reverseAnimateWindow( AnimateWindowCC *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initAnimateWindow( AnimateWindowCC *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::updateAnimateWindow( AnimateWindowCC *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::reverseAnimateWindow( AnimateWindowCC *animWin )
{
...
void ProcessAnimateWindowSlideFromTopFast::initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTopFast::initAnimateWindow( AnimateWindowCC *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTopFast::updateAnimateWindow( AnimateWindowCC *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTopFast::reverseAnimateWindow( AnimateWindowCC *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initReverseAnimateWindow( AnimateWindowCC *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initAnimateWindow( AnimateWindowCC *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D size = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRightFast::updateAnimateWindow( AnimateWindowCC *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRightFast::reverseAnimateWindow( AnimateWindowCC *animWin )
{
