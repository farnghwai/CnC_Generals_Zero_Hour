...
//-----------------------------------------------------------------------------
// AnimateWindowCC PUBLIC FUNCTIONS /////////////////////////////////////////////
//-----------------------------------------------------------------------------
AnimateWindowCC::AnimateWindowCC( void )
{
	m_delay = 0;
...
void AnimateWindowCC::setAnimData( 	ICoord2D startPos, ICoord2D endPos, 
...
void AnimateWindowManager::update( void )
{
	...
	if(m_needsUpdate)
	{
		...
		{
			AnimateWindowCC *animWin = *it;
			if (!animWin)
			{
				DEBUG_CRASH(("There's No AnimateWindowCC in the AnimateWindowCC List"));
				return;
			}
...
void AnimateWindowManager::registerGameWindow(GameWindow *win, AnimTypes animType, Bool needsToFinish, UnsignedInt ms, UnsignedInt delayMs)
{
	...
	// Create a new AnimateWindowCC class and fill in it's data.
	AnimateWindowCC *animWin = newInstance(AnimateWindowCC);	
