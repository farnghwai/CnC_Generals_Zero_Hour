...
protected:
	...
	virtual AudioManager *createAudioManager( void );				///< Factory for audio device //[DX9]
...
inline AudioManager* Win32GameEngine::createAudioManager(void) { return NULL; /*NEW MilesAudioManager*/; } //[DX9]
