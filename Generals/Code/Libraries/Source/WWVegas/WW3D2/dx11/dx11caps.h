...
{
public:
	static void Compute_Caps(DXGI_FORMAT display_format, DXGI_FORMAT depth_stencil_format, ID3D11Device* D3DDevice);
...
private:
	static void Init_Caps(ID3D11Device* D3DDevice);
	static void Check_Texture_Format_Support(DXGI_FORMAT display_format,const D3DCAPS8& caps);
	...
	static void Vendor_Specific_Hacks(const DXGI_ADAPTER_DESC& adapter_id);
